...
def new_sign_in():
    ...
    sign_btn = tk.Button(frame, text='Sign-up', font=("Arial", 16),cursor = 'hand2')
...
sign_in = tk.Button(frame, text="Sign Up", width = 6, border = 0,cursor = 'hand2',font=('Arial',13), command= new_sign_in)
